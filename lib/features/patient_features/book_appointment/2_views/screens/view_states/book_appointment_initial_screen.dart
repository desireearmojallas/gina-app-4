                    ...
                    child: TextFormField(
                      ...
                      onTap: () async {
                        ...
                        DateTime firstDayOfNextWeek =
                            firstDayOfThisWeek.add(const Duration(days: 7));

                        DateTime firstDate = now.isAfter(lastDayOfThisWeek)
                            ? firstDayOfNextWeek
                            : firstDayOfThisWeek;
                    ...
                    child: LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        for (var i = 0; i < startTimes.length; i++) {
                          final timeslot = '${startTimes[i]} - ${endTimes[i]}';
                                  ...
                                  return InkWell(
                                    ...
                                    child: BlocBuilder<BookAppointmentBloc,
                                      ...
                                      builder: (context, state) {
                                        final selectedIndex =
                                            state is GetDoctorAvailabilityLoaded
                                    ...
                                    return InkWell(
                                      onTap: () {
                                        ...
                                        if (currentState
                                          ...
                                          final afternoonIndex =
                                              index + morningTimeslots.length;

                                          if (selectedIndex == afternoonIndex) {
                                            bookAppointmentBloc.add(
                                              const SelectTimeEvent(
                                                index: -1,
                                                startingTime: '',
