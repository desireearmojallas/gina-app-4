...
class RescheduleFilledButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isReschedulable = appointmentDetailsBloc.canReschedule(
        appointmentDetailsBloc, appointment);
              ...
              ? () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      ...
                      backgroundColor:
                          GinaAppTheme.declinedTextColor.withOpacity(0.85),
