...
import 'package:gina_app_4/features/admin_features/admin_settings/2_views/screens/admin_settings_screen.dart';
    ...
    on<TabChangedEvent>((event, emit) {
      switch (event.tab) {
        ...
        case 1:
          emit(const AdminNavigationDrawerInitial(
              currentIndex: 1,
              selectedScreen: AdminVerifyDoctorScreenProvider()));
          break;
        case 2:
          emit(const AdminNavigationDrawerInitial(
              currentIndex: 2,
              selectedScreen: AdminDoctorListScreenProvider()));
          break;
        case 3:
          emit(const AdminNavigationDrawerInitial(
              currentIndex: 3,
              selectedScreen: AdminPatientListScreenProvider()));
          break;
        case 4:
          emit(const AdminNavigationDrawerInitial(
              currentIndex: 4, selectedScreen: AdminSettingsScreenProvider()));
          break;
        default:
          break;
      }
