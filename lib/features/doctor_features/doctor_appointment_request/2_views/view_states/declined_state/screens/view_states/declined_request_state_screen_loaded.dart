...
class DeclinedRequestStateScreenLoaded extends StatelessWidget {
  ...
  const DeclinedRequestStateScreenLoaded(
      {super.key, required this.declinedRequests});

  @override
  Widget build(BuildContext context) {
    final declinedRequestBloc = context.read<DeclinedRequestStateBloc>();
    ...
    return RefreshIndicator(
      onRefresh: () {
        declinedRequestBloc.add(
          DeclinedRequestStateInitialEvent(),
        );
        return Future.value();
      },
      child: ScrollbarCustom(
        child: declinedRequests.isEmpty
            ? Center(
                child: Column(
