...
class UpcomingAppointmentsForDoctorContainer extends StatelessWidget {
  ...
  const UpcomingAppointmentsForDoctorContainer({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        debugPrint(
            'SelectedPatientUid on upcoming container: $selectedPatientUid');
        ...
        Navigator.pushNamed(context, '/doctorOnlineConsultChat').then((value) {
          ...
          debugPrint('DoctorEConsultScreenLoaded');
        });

        //! to be continued... not navigating well
      },
      child: Container(
