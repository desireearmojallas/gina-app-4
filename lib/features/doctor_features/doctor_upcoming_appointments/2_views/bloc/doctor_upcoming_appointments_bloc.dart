...
import 'package:gina_app_4/features/doctor_features/doctor_upcoming_appointments/1_controllers/doctor_upcoming_appointments_controller.dart';
...
class DoctorUpcomingAppointmentsBloc extends Bloc<
  ...
  FutureOr<void> upcomingAppointmentsFilterEvent(
    ...
    upcomingAppointments.fold(
        (error) => emit(
            DoctorUpcomingAppointmentsError(errorMessage: error.toString())),
        (appointments) {
  ...
  FutureOr<void> navigateToApprovedRequestDetailEvent(
    ...
    patientData.fold((failure) {
      emit(DoctorUpcomingAppointmentsError(errorMessage: failure.toString()));
    }, (patientData) {
